...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //Player that wins can be make in on function with 1 argument for the winning player: 1 - firstPlayer; 2 - secondPlayer
    ...
    private void updatePointsText() {
        String updatePlayer1Points = "Player 1: " + player1Points;
        textViewPointsPlayer1.setText(updatePlayer1Points);
        String updatePlayer2Points = "Player 2: " + player2Points;
